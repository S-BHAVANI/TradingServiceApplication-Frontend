...
class UpdateStockComponent extends Component {
    ...
    updateStock = (e) => {
        e.preventDefault();
        let stock = {companyId:this.state.companyId,companyName: this.state.companyName, stockPrice: this.state.stockPrice, stockQuantity: this.state.stockQuantity, stockOrderType: this.state.stockOrderType};
                            ...
                            <div className = "card col-md-6 offset-md-3 offset-md-3">
                                ...
                                <div className = "card-body">
                                    ...
                                    <div className = "form-group">
                                            ...
                                            <input placeholder="CompanyId" name="companyId" className="form-control" 
